    ...
    <>
      <div className={`w-full pt-[80px] relative ${styles.hero}`}>
        <div className="w-[85%] m-auto grid lg:grid-cols-2 grid-cols-1 justify-center items-center">
          ...
          <div className="text-right mr-16 lg:mt-4 mt-20">
            <h1 className="lg:text-6xl text-5xl text-primary">
              {" "}
              دايما ليك مكان
            </h1>
            <div className="mt-6 mb-8 text-xl">
              ...
              <p>في دايما فرصة انك تنضم لفريقنا</p>
            </div>
            <button
            ...
            >
              <Link href={"/NotReady"}> تقدم للوظيقة</Link>
            </button>
          </div>
        </div>
