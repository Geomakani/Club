...
export default function TopNavigation() {
  ...
  return (
    <header
      className="h-20 relative z-10 w-screen"
      style={{ boxShadow: "0px 0px 10px 0px #000000" }}
    >
      <div className="flex h-full justify-center mx-auto relative px-3 text-white z-10 ">
        <div className="flex items-center pl-1 relative w-full sm:ml-0 sm:pr-2 lg:max-w-68 ">
          <div className="flex group h-full items-center absolute w-12  lg:right-16">
            <button
              type="button"
              aria-expanded="false"
          ...
          <div className="container flex left-0 relative w-3/4">
            <div className="group hidden items-center ml-8 relative w-full md:flex lg:w-72 text-right">
              ...
              <input
                type="text"
                className="bg-gray-800 block leading-normal pl-10 py-1.5 pr-4 ring-opacity-90 rounded-2xl text-gray-400 w-full focus:border-transparent focus:outline-none focus:ring-2 text-right"
                placeholder="ابحث"
              />
            </div>
          </div>
